...
export default function OptionsPanel({title,header,className, children, buttonLabel, onClickBtn}:any) {
  return (
    <div className={`flexible--column options-panel ${className}`}>
        {title!="" && 
       ...
       {header && <div className='optionsPanelHeader'>
          {header()}
       </div>}

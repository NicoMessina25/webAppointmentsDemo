...
export default function ErrorModal({visible,setVisible}:any) {
  ...
  return (
        <Modal visible={visible} setVisible={setVisible} header={header} footerButtonRightText={footerButtonRightText} onClickRightBtn={onClickRightBtn} pathRightBtn={"#"} footermessage={FooterMessage}> 
        </Modal>
  )
}
